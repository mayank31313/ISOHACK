              ...
              <div class="classynav">
                <ul>
                  ...
                  <!-- <li><a href="#">Services</a>
                    <ul class="dropdown">
                      <li><a href="index.html">Sell Crop</a></li>
                      <li><a href="about.html">Buy Crop</a></li>
                    </ul>
                  </li> -->
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="footer-widget mb-80">
              ...
              <div class="contact-info">
                <p><i class="fa fa-map-pin" aria-hidden="true"></i><span>Crystal IT park, Indore</span></p>
                <p><i class="fa fa-envelope" aria-hidden="true"></i><span>itsolution@gmail.com</span></p>
                <p><i class="fa fa-phone" aria-hidden="true"></i><span>+91 2345656123</span></p>
              </div>
            </div>
          </div>
